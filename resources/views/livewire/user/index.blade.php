...
<div class="max-w-5xl mx-auto mb-20">
    ...
    <div class="max-w-6xl mx-auto mb-20">
        ...
        <p class="text-gray-700 leading-relaxed text-lg">
            ...
            <span class="font-semibold text-gray-900">Makati Science and Technology Institute of the Philippines</span>
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-10">
            ...
            <div>
                ...
                <p class="text-gray-700 mb-2">
                    📍 <span class="font-semibold text-gray-700">Makati Science and Technology Institute of the Philippines</span>
                </p>
                <p class="text-gray-700 mb-2">
